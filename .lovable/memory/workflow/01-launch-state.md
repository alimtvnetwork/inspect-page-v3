...
Current shipped: Extension **v2.7.5** + WP plugin **v2.6.0**.

## ✅ Done this session
- Export dropdown silent-failure fix (anchor download instead of `showSaveFilePicker`)
...
- CWS screenshots (1280×800) → `store-assets/screenshots-v2.7.5/`
- Upload `public/inspect-page.zip` to Chrome Web Store dashboard
- Git tag `ext-v2.7.5` (`git tag ext-v2.7.5 && git push origin ext-v2.7.5`)
