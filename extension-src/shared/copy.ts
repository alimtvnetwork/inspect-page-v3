...
export const COPY = {
  ...
  inspectTokensVariants: "Variants",
  inspectTokensTint: "Tint",
  inspectTokensBase: "Base",
  inspectTokensShade: "Shade",
  inspectTokensUsedBy: "Used by {n} selectors",
  inspectTokensCustomCss: "Custom CSS for {selector}",
  inspectTokensCustomCssPh: "/* extra CSS declarations for this selector */",
